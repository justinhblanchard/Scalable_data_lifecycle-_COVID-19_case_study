...
plt.savefig('/Users/ihz/Desktop/Covid_Research/plots/' + filename + '_scree.png', bbox_inches = 'tight')
df.rename({0:'pca1', 1:'pca2'}, axis = 1, inplace = True)
df.reset_index(drop = True, inplace = True)
df1.reset_index(drop = True, inplace = True)
df1 = pd.concat([df1, df], axis = 1)
df1.to_csv('/Users/ihz/Desktop/Covid_Research/data/pca_' + filename, index = False)